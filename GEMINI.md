# Gemini Project Context: Treino Academia
...
## Key Files
- **docs/index.html**: The core of the project. A comprehensive, well-formatted HTML document providing:
    ...
    - **Detailed Workouts**: Specific exercises, sets, reps, and "Reps in Reserve" (RIR) targets for each training day.
    - **Cardio & Mobility**: Recommendations for supplementary activities.

## Usage
The contents are intended to be viewed as a reference for a personalized gym routine.
- **Viewing**: Open `docs/index.html` in any web browser to view the full training protocol.
...
- **Intensity**: RIR 2-3 (leaving 2-3 reps in the tank) to minimize injury risk.
- **Recovery**: 48-72h between sessions.
- **Safety**: Avoidance of axial loading (spinal compression) and focus on neutral spine alignment.
- **Nutrition**: High protein intake (~2.0-2.2g per kg/day) recommended for older adults.
